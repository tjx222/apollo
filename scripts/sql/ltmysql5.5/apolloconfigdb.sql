...
CREATE TABLE `App` (
  ...
  `DataChange_LastTime` timestamp NULL DEFAULT '2000-01-01 00:00:00' COMMENT '最后修改时间',
  PRIMARY KEY (`Id`),
  KEY `AppId` (`AppId`(191)),
...
CREATE TABLE `Instance` (
  ...
  `DataChange_CreatedTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `DataChange_LastTime` timestamp NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '最后修改时间',
  PRIMARY KEY (`Id`),
